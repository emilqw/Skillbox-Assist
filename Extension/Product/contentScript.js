...
var DOMManager = /*#__PURE__*/function () {
  ...
  return _createClass(DOMManager, null, [{
    key: "insertElement",
    value:
    /**
     ...
     */
    function insertElement(parentSelector, elementToInsert, insertPosition) {
...
/* harmony import */ var _components_DOMManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/DOMManager */ "./Dev/components/DOMManager.js");


var button = new _components_SabiButton__WEBPACK_IMPORTED_MODULE_0__.SabiButton("HiBye", "primary", function () {
  console.log("Нажата кнопка- Привет-Пока");
  var p = document.createElement("p");
  p.textContent = "Привет, как дела?";
  var p2 = document.createElement("p");
  p2.textContent = "Прощай, мир!";
  _components_DOMManager__WEBPACK_IMPORTED_MODULE_1__.DOMManager.insertElement('div[data-e2e="wysiwyg-editor"] .fr-element.fr-view.custom-theme', p, 'afterbegin');
  _components_DOMManager__WEBPACK_IMPORTED_MODULE_1__.DOMManager.insertElement('div[data-e2e="wysiwyg-editor"] .fr-element.fr-view.custom-theme', p2, 'beforeend');
});
button.element.classList.add("fr-command", "fr-btn");
_components_DOMManager__WEBPACK_IMPORTED_MODULE_1__.DOMManager.insertElement('.form__actions.ng-star-inserted', button.element, 'beforeend');
})();
